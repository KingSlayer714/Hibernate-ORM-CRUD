...
Query<TouristLocation> q=ses.createQuery("from TouristLocation where city = :p1 ORDER BY averageRating DESC LIMIT 2");
...
for(int i=0;i<list.size();i++)
{
	...
	out.println("No location available for "+city);
}
ses.close();
%>
	</table>
